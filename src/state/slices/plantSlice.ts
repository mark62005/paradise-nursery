...
export const initialState: InitialStateType = {
	plants: [
		{
			id: "C001",
			name: PlantCategoryName.AirPurifying,
			plants: [
				{
					id: "P001",
					name: "Snake Plant",
		...
		{
			id: "C002",
			name: PlantCategoryName.AromaticFragrant,
			plants: [
				{
					id: "P007",
					name: "Lavender",
		...
		{
			id: "C003",
			name: PlantCategoryName.InsectRepellent,
			plants: [
				{
					id: "P013",
					name: "oregano",
		...
		{
			id: "C004",
			name: PlantCategoryName.Medicinal,
			plants: [
				{
					id: "P019",
					name: "Aloe Vera",
		...
		{
			id: "C005",
			name: PlantCategoryName.LowMaintenance,
			plants: [
				{
					id: "P025",
					name: "ZZ Plant",
...
export function selectPlants(state: RootState): PlantCategory[] {
	return state.plant.plants;
}
